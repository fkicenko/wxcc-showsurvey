...
export declare type Task = Service.Aqm.Contact.AgentContact["data"];
export declare type TaskMap = Map<TaskId, Task>;
export declare class ModuleAgentContact {
    /**
     * Observable block
     */
    taskMap: TaskMap;
    ...
    interactionControlDimension: {
        mainSection: number;
        consultSection: number;
    };
    /**
     * Utils block
     */
    private popoverEventTypes;
    private isNonTerminatedTask;
    private isAgentContactInRingingState;
    private isAgentContactInOfferConsultState;
    private isValidAgentContactForPopover;
    private isValidAgentContactAssignedForPopover;
    private isOtherValidEventForPopover;
    private isValidEventForPopover;
    private getDestinationAgentId;
    private findMediaResourceId;
    private findHoldTimestamp;
    private findHoldStatus;
    flattenTaskForInteractionControl: (data: Task, agentId: string, hasCustomerLeft?: boolean | undefined, isConvNotFound?: boolean | undefined) => InteractionControlNS.Interaction | undefined;
    flattenTaskForTaskList: (data: Task, agentId: string) => TaskList.Task;
    isPrimary: (data: Task, agentId: string) => boolean;
    getTaskIdFromConvId: (convId: string) => {
    ...
    checkBeforeSelectingTask(taskId: string): void;
    ...
    get contact(): {
        ...
        chatMessages: Service.Cms.ChatResponseDataListAttributes[];
    };
