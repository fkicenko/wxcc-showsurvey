...
export declare const findMatchingKey: (shortcutKeyMap: Map<string, Service.shortcut.KeyInfo>, event?: KeyboardEvent | undefined) => Service.shortcut.KeyInfo | undefined;
