export declare namespace Notifications {
    ...
    export class Item implements ItemMeta.RawData, ItemMeta.UserControlled {
        ...
        get reason(): ItemMeta.AddEventReason | ItemMeta.PendingEventReason | ItemMeta.ActivateEventReason | ItemMeta.DeactivateEventReason | ItemMeta.RemoveEventReason | undefined;
    ...
    export class Service {
        ...
        static sortTimestampsFn: (timestamp1: string, timestamp2: string) => 0 | 1 | -1;
        static sortByTimestampsFn(n1: Notifications.Item, n2: Notifications.Item): 0 | 1 | -1;
